(function (global, factory) {
  ...
  var huHU$1 = locale$2({
    ...
    days: ["vasárnap", "hétfo", "kedd", "szerda", "csütörtök", "péntek", "szombat"],
  ...
  var plPL$1 = locale$2({
    ...
    shortDays: ["Niedz.", "Pon.", "Wt.", "Sr.", "Czw.", "Pt.", "Sob."],
    months: ["Styczen", "Luty", "Marzec", "Kwiecien", "Maj", "Czerwiec", "Lipiec", "Sierpien", "Wrzesien", "Pazdziernik", "Listopad", "Grudzien"],
    shortMonths: ["Stycz.", "Luty", "Marz.", "Kwie.", "Maj", "Czerw.", "Lipc.", "Sierp.", "Wrz.", "Pazdz.", "Listop.", "Grudz."]/* In Polish language abbraviated months are not commonly used so there is a dispute about the proper abbraviations. */
  });
